...
class ReportController extends Controller
{
    public function __invoke(Request $request, AdminReportService $reportService): Response
    {
        $validated = $request->validate([
            'tab' => ['nullable', 'in:checkin,finance,agent,customer,after_event'],
        ...
        return Inertia::render('admin/reports/index', [
            ...
            'tabs' => [
                ...
                ['value' => 'customer', 'label' => 'Data Customer'],
            ...
            'checkin' => $reportService->checkIn($filters, true),
            'finance' => $reportService->finance($filters, true),
            'agent' => $reportService->agent($filters, true),
            'customer' => $reportService->customer($filters, true),
            'after_event' => $reportService->afterEvent($filters, true),
            'export_urls' => [
                'checkin' => [
                ...
                'after_event' => [
                    'xlsx' => route('admin.reports.export', ['tab' => 'after_event', 'format' => 'xlsx']),
                    'pdf' => route('admin.reports.export', ['tab' => 'after_event', 'format' => 'pdf']),
                ],
            ],
        ]);
    }
